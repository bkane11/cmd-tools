...
#---------------------------------------------------------- 
$search = "png" 
$dest   = "C:\Projects\VenturaCountyMHMP\assets\images" 
$zips   = "S:\Trumpy\For Pavel\Map Packages" 
...
Function GetZipFiles 
{ 
  $zipFiles = Get-ChildItem -Path $zips -Recurse -Filter "*.kmz" | % { $_.DirectoryName + "\$_" } 
